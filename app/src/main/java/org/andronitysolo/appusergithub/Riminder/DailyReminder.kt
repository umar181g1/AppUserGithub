package org.andronitysolo.appusergithub.Riminder
...
class DailyReminder : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        Log.d("umar", "umar:${type},${message}")
        Log.d("umar", "Dailry Rimember")
...
//        showToast(context, title, message)
        ...
        if (context != null) {
            if (message != null) {
                showUPNotif(context, title, message, notifId)
            }
        }
    }
    ...
    private fun showUPNotif(context: Context, title: String, message: String, notifId: Int) {
    ...
    fun setAlarm(context: Context, time: String, isStart: Boolean) {
        if (isStart) {
            ...
            intent.putExtra(EXTRA_MESSAGE, "Hallo Kembali lgk yuk ke aplikasi ini")

            Log.d("wqa", "alarmh:${time}")
